    ...
    <div style={S.app}>
      ...
      <div style={S.main}>
        ...
        <div style={S.content}>
          ...
          {area==="admin" && <PannelloAdmin setCatalog={setCatalog}/>}
        </div>
...
function PannelloAdmin({ setCatalog }) {
    ...
    try {
      ...
      for (let i = 0; i < chunks.length; i++) {
        ...
        if (r.ok) {
          ...
          addLog(`Batch ${i+1}/${chunks.length}: ${done}/${prodotti.length} prodotti importati ✓`);
        } else {
          const err = await r.text();
          errori++;
          addLog(`Batch ${i+1}/${chunks.length}: errore — ${err.slice(0,100)}`, "errore");
        }
