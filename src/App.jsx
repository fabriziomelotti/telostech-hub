...
// Nota: la gestione utenti non usa più la service_role key lato client — vedi
// GestioneUtenti più sotto, che chiama la Edge Function `admin-users`.
...
// A differenza dell'import catalogo, QUI non c'è nessuna service_role key nel
// browser: tutte le operazioni passano dalla Edge Function `admin-users`, che
// verifica lato server che chi chiama sia autenticato e abbia ruolo admin.
